...
public class Datos {
    ...
    public Datos() {
        ...
        //fgg
        datos.add(new Anuncio(1, "Busco amiguitos para salir por ahi", (new Usuario(1, R.drawable.usuario_1, "julia@gmail.com", "123456", "Julia Ramirez", "Chamartin", "Soy una chica muy guay y me todo eso"))));
        datos.add(new Anuncio(2, "Busco amiguitas para jugar al ping pong", (new Usuario(2, R.drawable.usuario_2, "mikel@gmail.com", "654321", "Mikel Izubirraga", "Bernabeu", "Soy una chico muy enrollado"))));
